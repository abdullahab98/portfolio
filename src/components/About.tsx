  ...
  return (
    <section id="about" className="relative py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 rounded-2xl bg-[#0b0f19]/90 border border-white/[0.08] overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.6)] backdrop-blur-xl">
          {/* Terminal Title Bar */}
          <div className="flex items-center justify-between px-4 py-3 bg-white/[0.03] border-b border-white/[0.06]">
            ...
            <span className="text-xs font-mono text-slate-400">abdullah@system-arch:~</span>
            <button
          ...
          <div className="p-5 font-mono text-xs text-slate-300 space-y-3 leading-relaxed">
            ...
            <div className="bg-black/40 p-4 rounded-xl border border-white/[0.04] text-[11px] sm:text-xs text-slate-300 space-y-1">
            ...
            <div className="pt-2 flex items-center gap-2 text-slate-400">
              ...
              <span className="text-[11px]">System integrity optimal • Latency: 12ms</span>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="p-6 rounded-2xl bg-white/[0.02] border border-cyan-500/20 backdrop-blur-xl relative group hover:border-cyan-400/50 transition-all">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl bg-cyan-500/10 border border-cyan-500/30 flex items-center justify-center shrink-0 text-cyan-400 group-hover:scale-105 transition-transform">
          ...
          <div className="p-6 rounded-2xl bg-white/[0.02] border border-purple-500/20 backdrop-blur-xl relative group hover:border-purple-400/50 transition-all">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl bg-purple-500/10 border border-purple-500/30 flex items-center justify-center shrink-0 text-purple-400 group-hover:scale-105 transition-transform">
