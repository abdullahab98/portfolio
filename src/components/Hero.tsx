  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center flex flex-col items-center">
        {/* Top Tag Pill */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/[0.04] border border-cyan-500/30 backdrop-blur-md mb-8 hover:border-cyan-400/60 transition-all shadow-[0_0_20px_rgba(0,240,255,0.15)] group">
          <Sparkles className="w-4 h-4 text-cyan-400 animate-pulse" />
          <span className="text-xs font-mono text-cyan-300 tracking-wide uppercase">
            Full-Stack Software Engineer • UMS Systems Developer
          </span>
        </div>
        ...
        <p className="text-lg sm:text-xl md:text-2xl text-slate-300 max-w-3xl font-light leading-relaxed mb-10">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mb-16 w-full sm:w-auto">
          ...
          <a
            href="#contact"
            className="group inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-sm font-medium text-slate-200 bg-white/[0.04] hover:bg-white/[0.09] border border-white/[0.12] hover:border-cyan-400/50 backdrop-blur-md transition-all duration-300 hover:text-white hover:-translate-y-0.5"
          >
